...
// ==========================================================================
const playlistCD = [
    { titulo: "To pagando pra ver (Jescklay Mattos)", arquivo: "musicas/To pagando pra ver (Jescklay Mattos).mp3" },
    { titulo: "Não vou olhar para traz (Jescklay Mattos)", arquivo: "musicas/Não vou olhar para traz (Jescklay Mattos).mp3" },
    { titulo: "Conto de fadas (Jescklay Mattos)", arquivo: "musicas/Conto de fadas (Jescklay Mattos).mp3" }
];
